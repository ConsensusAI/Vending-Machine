...
public interface VendServiceLayer {
    ...
    boolean checkStock(String itemId) throws VendPersistenceException;

    boolean compareMoney(BigDecimal userMoney, String itemId) throws VendPersistenceException;
